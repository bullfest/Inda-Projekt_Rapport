...
\begin{titlepage}
	\begin{center}
		...
		{\large A game for landlubbers to feel the breeze of seven seas} \\ [1.5cm]
...
Användaren kör spelet. Vi frågar användaren om spelmekaniken var tillfredsställande och om det uppstod några buggar.

\subsection{C}
Unit-tester uteblev då vi aldrig fann behovet av dem. Ursprungligen tänkte vi bara använda unit-tester för några få saker så när de inte genomsyrade hela processen så var de lätta att glömma. Om vi verkligen skulle använda unit-tester så hade vi nog behövt tillämpa dem överallt.
